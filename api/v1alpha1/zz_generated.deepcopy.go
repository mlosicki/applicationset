...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PullRequestBuildStatusFilter) DeepCopyInto(out *PullRequestBuildStatusFilter) {
	*out = *in
	if in.SuccessfulBuilds != nil {
		in, out := &in.SuccessfulBuilds, &out.SuccessfulBuilds
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PullRequestBuildStatusFilter.
func (in *PullRequestBuildStatusFilter) DeepCopy() *PullRequestBuildStatusFilter {
	if in == nil {
		return nil
	}
	out := new(PullRequestBuildStatusFilter)
	in.DeepCopyInto(out)
	return out
}
